...
var CPF = /*#__PURE__*/function () {
  ...
  _createClass(CPF, [{
    ...
    value: function validator() {
      ...
      var cfpParcial = this.cpfOnly.slice(0, -2);
      var digit01 = CPF.checkDigit(cfpParcial);
      var digit02 = CPF.checkDigit(cfpParcial + digit01);
      var cpfInteiro = cfpParcial + digit01 + digit02;
      return cpfInteiro === this.cpfOnly;
    }
  }], [{
    key: "checkDigit",
    value: function checkDigit(cpfParcial) {
      var cpfArray = Array.from(cpfParcial);
      var count = cpfArray.length + 1;
      var soma = cpfArray.reduce(function (acumulator, value) {
...
var GeraCPF = /*#__PURE__*/function () {
  ...
  _createClass(GeraCPF, [{
    ...
    value: function geraNovoCPF() {
      ...
      var digito1 = _CPF__WEBPACK_IMPORTED_MODULE_0__["default"].checkDigit(cpfSemDigito);
      var digito2 = _CPF__WEBPACK_IMPORTED_MODULE_0__["default"].checkDigit(cpfSemDigito + digito1);
